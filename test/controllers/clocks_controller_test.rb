...
class ClocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clock" do
    assert_difference("Clock.count") do
      post clocks_url, params: { clock: { project_id: @clock.project_id, user_id: @clock.user_id } }
    end
  ...
  test "should update clock" do
    patch clock_url(@clock), params: { clock: { project_id: @clock.project_id, user_id: @clock.user_id } }
